...
// Build query for EVENT events only
$sql = "SELECT * FROM events WHERE end_date > NOW() AND type = 'Event'";
$count_sql = "SELECT COUNT(*) as total FROM events WHERE end_date > NOW() AND type = 'Event'";
...
<head>
    ...
    <title>Campus Events - CampusConnect</title>
...
<body>
    ...
    <section class="event-header">
        <div class="event-header-content">
            <h1 class="event-title">🎉 Campus Events</h1>
            <p class="event-subtitle">Discover exciting events, workshops, and activities happening across campus</p>
    ...
    <div class="main-container">
        ...
        <div class="profile-warning">
            ...
            You need to complete your student profile before you can register for any events. 
        ...
        <div class="controls-section">
            <form method="GET" class="controls-grid">
                <div class="search-box">
                    ...
                    <input type="text" name="search" class="search-input" placeholder="Search events by name or description..." value="<?= htmlspecialchars($search) ?>">
                </div>
        ...
        <div class="events-header">
            ...
            <div class="results-count">
                Showing <?= count($events) ?> of <?= $total_events ?> events
            </div>
        </div>
            ...
            <div class="events-grid">
                ...
                <div class="event-card">
                    <div class="event-image-container">
                        ...
                        <?php else: ?>
                        <div style="background: linear-gradient(135deg, #bfdbfe 0%, #3b82f6 100%); height: 100%; display: flex; align-items: center; justify-content: center; color: white; font-size: 3rem;">
                            🎉
                        </div>
                        <?php endif; ?>
                    ...
                    <div class="event-content">
                        ...
                        <div class="event-meta">
                            ...
                            <div class="meta-item">
                                ...
                                <span>
                                    ...
                                    <?php if($is_expired): ?>
                                        <span style="color: #ef4444;">Event Ended</span>
                                    <?php elseif($days_until_start <= 0): ?>
                                        <span style="color: #10b981;">Happening Now</span>
                                    <?php elseif($days_until_start <= 7): ?>
                                        <span style="color: #f59e0b;">Coming Soon (<?= $days_until_start ?> days)</span>
                                    <?php else: ?>
                                        <span style="color: #3b82f6;">Registration Open</span>
                                    <?php endif; ?>
                                </span>
                            </div>
                        </div>
                        ...
                        <?php elseif(!$student_profile || !$student_profile['is_profile_complete']): ?>
                            <button class="btn" disabled>
                                <i class="fas fa-lock"></i> Complete Profile to Register
                            </button>
                        <?php else: ?>
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <p>
                    <?php if($search): ?>
                        We couldn't find any events matching "<?= htmlspecialchars($search) ?>". 
                ...
                <?php if($search): ?>
                    <a href="event_full.php" class="btn" style="width: auto; display: inline-block; padding: 0.75rem 1.5rem;">
                        <i class="fas fa-undo"></i> View All Events
                    </a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    ...
    <script>
        ...
        function updateEventCountdowns() {
            ...
            eventElements.forEach(card => {
                const startDateElem = card.querySelector('.meta-item:nth-child(1) span');
                if (startDateElem) {
                    const startText = startDateElem.textContent;
                    const startMatch = startText.match(/Start: (.+)/);
                    if (startMatch) {
                        ...
                        if (diffDays > 0 && diffDays <= 7) {
                            ...
                            const statusElem = card.querySelector('.meta-item:nth-child(3) span');
                            if (statusElem && !statusElem.querySelector('.countdown')) {
                                statusElem.innerHTML += ` <span class="countdown" style="color: #f59e0b;">(${diffDays}d)</span>`;
                            }
                        }
                    }
                }
